...
Page({
  ...
  onLoad: function (options = {}) {
    ...
    if (team_id && project_id) {
      ...
      this.team_id = team_id;
        ...
        this.project_id = wx.getStorageSync("local_project_id");
        this.team_id = wx.getStorageSync("team_id");
    }
    this.setData({project_id : this.project_id});
      ...
      //console.log('record_new onload', this.project_id);
      //console.log('record_new onload', options, this.project_id , this.team_id);
  ...
  getMonthStatus: function (month) {
    ...
    dmNetwork.get(
      dmNetwork.attdanceMonthStatus2,
      params,
      (res) => {
        const { data } = res.data;
        this.setData({
    ...
    dmNetwork.get(
      ...
      (res) => {
        ...
        this.setData({
          ...
          working_hours_info: data.working_hours_info
        });
      },
      (error) => {}
    );
  ...
  goMineWork: function (e) {
      const url = "../../minework/minework";
